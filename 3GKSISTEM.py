...
def calcular():
    try:
        ...
        valores = [float(entry.get()) if entry.get() else 0 for entry in entries]
        ...
        nf2 = valores[3] * 0.16 + valores[4] * 0.20 + valores[10] * 45.00 + valores[11] * 26.00 + valores[12] * 2.33 + valores[13] * 97.50 + valores[14] * 19.00
        peso = valores[0] * 0.01 + valores[1] * 0.01 + valores[2] * 0.01 + valores[13] * 6.00 + valores[9] * 6.00 + valores[5] * 0.03 + valores[6] * 0.03 + valores[7] * 6.00
        peso2 = valores[3] * 0.025 + valores[4] * 0.01 + valores[8] * 10.00 + valores[10] * 10.00 + valores[12] * 0.0035 + valores[11] * 0.5 + valores[14] * 10.00
        ...
        for i in range(5):  # Aplicando regras para os primeiros 5 produtos
            qtd = valores[i]
